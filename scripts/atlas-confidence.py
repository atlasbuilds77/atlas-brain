#!/usr/bin/env python3
"""
ATLAS CONFIDENCE/EMOTION SYSTEM
...
CONFIDENCE_LOG = CLAWD_DIR / "memory" / "confidence-log.jsonl"
...
def main():
    ...
    if len(sys.argv) < 2:
        print("ATLAS CONFIDENCE SYSTEM")
        print("=" * 40)
        print("Usage:")
        print("  atlas-confidence.py log <topic> <level> [reasoning]")
        print("  atlas-confidence.py recent [n]")
        print("  atlas-confidence.py analyze")
        print("")
