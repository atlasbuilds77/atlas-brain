...
GUT_LOG = MEMORY_DIR / "gut-checks.jsonl"
...
RED_FLAGS = [
    ...
    "revenge", "double down", "make it back", "impulse"
]

# Green flags indicating good process
GREEN_FLAGS = [
    "researched", "tested", "thought about", "small",
    "backup plan", "can afford to lose", "diversified", "understood",
    "planned", "data shows", "historically", "probability",
    "consulted", "slept on it", "pros and cons"
]
...
def main():
    if len(sys.argv) < 2:
        print("GUT CHECK SYSTEM")
        print("=" * 40)
        print("Implements somatic markers for decision-making")
        print("")
        print("Usage:")
        print("  gut-check.py check <decision> [context]")
        print("  gut-check.py history [n]")
        print("")
        print("Example:")
        print('  gut-check.py check "Buy expensive item" "Researched, can afford it"')
        return
